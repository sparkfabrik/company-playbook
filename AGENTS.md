...
- **No filler patterns.** No throat-clearing openers ("This document aims to", "It's worth noting that"), no summary outros ("In conclusion", "Overall"), no hype symmetry ("not only X but also Y"), no decorative triads, no exclamation points.
